...
<div
	...
	class={[
		...
		"data-[orientation=horizontal]:border-border data-[orientation=horizontal]:w-full data-[orientation=horizontal]:items-end data-[orientation=horizontal]:border-b-2",
